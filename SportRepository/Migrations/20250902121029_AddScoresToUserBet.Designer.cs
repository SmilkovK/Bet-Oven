...
namespace SportRepository.Migrations
{
    ...
    [Migration("20250902121029_AddScoresToUserBet")]
    partial class AddScoresToUserBet
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportDomain.models.BetConfirm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BetConfirms");
                });

            modelBuilder.Entity("SportDomain.models.FavoriteLeague", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SportDomain.Identity.BetUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SportDomain.models.UserBet", b =>
                {
                    b.HasOne("SportDomain.models.BetConfirm", "BetConfirm")
                        .WithMany("Bets")
                        .HasForeignKey("BetConfirmId")
